...
void draw(void){
    ...
    glBegin(GL_POLYGON);
        glColor3f(hexagon.cor[0], hexagon.cor[0], hexagon.cor[0]);
        glVertex3f(hexagon.ponto[0][0], hexagon.ponto[0][1], hexagon.ponto[0][2]);
        glVertex3f(hexagon.ponto[1][0], hexagon.ponto[1][1], hexagon.ponto[1][2]);
        glVertex3f(hexagon.ponto[2][0], hexagon.ponto[2][1], hexagon.ponto[2][2]);
        glVertex3f(hexagon.ponto[3][0], hexagon.ponto[3][1], hexagon.ponto[3][2]);
        glVertex3f(hexagon.ponto[4][0], hexagon.ponto[4][1], hexagon.ponto[4][2]);
        glVertex3f(hexagon.ponto[5][0], hexagon.ponto[5][1], hexagon.ponto[5][2]);
        glColor3f(hexagon.cor[0], hexagon.cor[0], hexagon.cor[0]);
    glEnd();

    glShadeModel(GL_FLAT);
    glBegin(GL_TRIANGLES);
        glColor3f(triangulo_0.cor[0], triangulo_0.cor[1], triangulo_0.cor[2]);
        glVertex3f(triangulo_0.ponto[0][0], triangulo_0.ponto[0][1], triangulo_0.ponto[0][2]);
        glVertex3f(triangulo_0.ponto[1][0], triangulo_0.ponto[1][1], triangulo_0.ponto[1][2]);
        glVertex3f(triangulo_0.ponto[2][0], triangulo_0.ponto[2][1], triangulo_0.ponto[2][2]);
        glColor3f(triangulo_0.cor[0], triangulo_0.cor[1], triangulo_0.cor[2]);
    glEnd();
    ...
    glBegin(GL_TRIANGLES);
        glColor3f(triangulo_1.cor[0], triangulo_1.cor[1], triangulo_1.cor[2]);
        glVertex3f(triangulo_1.ponto[0][0], triangulo_1.ponto[0][1], triangulo_1.ponto[0][2]);
        glVertex3f(triangulo_1.ponto[1][0], triangulo_1.ponto[1][1], triangulo_1.ponto[1][2]);
        glVertex3f(triangulo_1.ponto[2][0], triangulo_1.ponto[2][1], triangulo_1.ponto[2][2]);
        glColor3f(triangulo_1.cor[0], triangulo_1.cor[1], triangulo_1.cor[2]);
    glEnd();
    ...
    glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
    glBegin(GL_TRIANGLES);
        glColor3f(triangulo_2.cor[0], triangulo_2.cor[1], triangulo_2.cor[2]);
        glVertex3f(triangulo_2.ponto[0][0], triangulo_2.ponto[0][1], triangulo_2.ponto[0][2]);
        glVertex3f(triangulo_2.ponto[1][0], triangulo_2.ponto[1][1], triangulo_2.ponto[1][2]);
        glVertex3f(triangulo_2.ponto[2][0], triangulo_2.ponto[2][1], triangulo_2.ponto[2][2]);
        glColor3f(triangulo_2.cor[0], triangulo_2.cor[1], triangulo_2.cor[2]);
    glEnd();
    ...
    glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
    glBegin(GL_TRIANGLES);
        glColor3f(triangulo_3.cor[0], triangulo_3.cor[1], triangulo_3.cor[2]);
        glVertex3f(triangulo_3.ponto[0][0], triangulo_3.ponto[0][1], triangulo_3.ponto[0][2]);
        glVertex3f(triangulo_3.ponto[1][0], triangulo_3.ponto[1][1], triangulo_3.ponto[1][2]);
        glVertex3f(triangulo_3.ponto[2][0], triangulo_3.ponto[2][1], triangulo_3.ponto[2][2]);
        glColor3f(triangulo_3.cor[0], triangulo_3.cor[1], triangulo_3.cor[2]);
    glEnd();
    ...
    glBegin(GL_TRIANGLES);
        glColor3f(triangulo_4.cor[0], triangulo_4.cor[1], triangulo_4.cor[2]);
        glVertex3f(triangulo_4.ponto[0][0], triangulo_4.ponto[0][1], triangulo_4.ponto[0][2]);
        glVertex3f(triangulo_4.ponto[1][0], triangulo_4.ponto[1][1], triangulo_4.ponto[1][2]);
        glVertex3f(triangulo_4.ponto[2][0], triangulo_4.ponto[2][1], triangulo_4.ponto[2][2]);
        glColor3f(triangulo_4.cor[0], triangulo_4.cor[1], triangulo_4.cor[2]);
    glEnd();
